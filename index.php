    ...
    <header id="header" class="header js-header">
      <div class="header__inner inner">
        <h1 class="header__logo">
          <a href="#" class="header__image"><img src="./assets/images/common/CodeUps_logo.png" alt=""></a>
        </h1>
          ...
          <div class="mv__images">
            ...
            <div class="swiper js-mv-swiper u-desktop">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_pc1.png" alt="">
                </div>

                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_pc2.png" alt="">
                </div>

                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_pc3.png" alt="">
                </div>

                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_pc4.png" alt="">
                </div>
              </div>
            </div>
            ...
            <div class="swiper js-mv-swiper u-mobile">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_1.png" alt="">
                </div>
  
  
                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_2.png" alt="">
                </div>
  
  
  
                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_3.png" alt="">
                </div>
  
  
                <div class="swiper-slide mv__image">
                  <img src="./assets/images/common/mv_4.png" alt="">
                </div>
      ...
      <section class="about top-about">
        ...
        <div class="about__inner inner">
          ...
          <div class="about__container">
            ...
            <div class="about__wrapper">
              <div class="about__back-image">
                <img src="./assets/images/common/about_2.png" alt="">
              </div>
              <div class="about__image">
                <img src="./assets/images/common/about_1.png" alt="">
              </div>
            </div>
          ...
          <div class="about__background u-desktop">
            <img src="./assets/images/common/about_sango.png" alt="">
            ...
            <div class="blog__cards cards">
              ...
              <a href="#" class="cards__card card">
                <div class="card__image">
                  <img src="./assets/images/common/blog_1.png" alt="">
                </div>
              ...
              <a href="#" class="cards__card card">
                <div class="card__image">
                  <img src="./assets/images/common/blog_2.png" alt="">
                </div>
                <div class="card__body">
                  <div class="card__header">
                    <time class="card__date">2023.11/17</time>
              ...
              <a href="#" class="cards__card card">
                <div class="card__image">
                  <img src="./assets/images/common/blog_3.png" alt="">
                </div>
                <div class="card__body">
                  <div class="card__header">
                    <time class="card__date">2023.11/17</time>
      ...
      <section class="voice top-voice">
        <div class="voice__inner inner">
          <div class="voice__bg-image u-desktop">
            <img src="./assets/images/common/voice_tatsu.png" alt="">
          </div>

          <div class="voice__background u-desktop">
            <img src="./assets/images/common/voice_goldfish.png" alt="">
          </div>
            ...
            <ul class="footer__sns-links">
              ...
              <li class="footer__sns-link">
                <a href="#" class="footer__insta">
                  <img src="./assets/images/common/InstagramLogo.png" alt="">
                </a>
              </li>
            </ul>
          </div>
